---
title: 'Bonsai LLM Benchmark: Jetson Orin Nano Super 8GB'
date: 2026-06-08
permalink: /posts/jetson-orin-nano-super-bonsai-benchmark/
author_profile: false
excerpt: "5 Bonsai-family 1–1.58bit LLMs benchmarked across 4 power modes on Jetson Orin Nano Super 8GB. 25W sweet spot: 47–48% more tok/s than 15W, best output tok/J for all sub-4B models."
header:
  ...
  og_image_alt: "Jetson Orin Nano Super 8GB used for the Bonsai LLM inference benchmark"
tags:
  - Jetson
  - Benchmark
  - Bonsai
...
*My Jetson Nano Orin Super cluster setup - its [real](https://www.smolhub.com/posts/jetson-orin-nano-cluster-setup-guide/)!*
...
![Tok/s vs Prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/1_tok_s_vs_prompt_gen512.png)
...
![Canonical Cell Comparison](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/11_canonical_cell_comparison_ctx2048_gen512.png)
...
![Output Tok/J vs Prompt](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/2_tok_j_vs_prompt_gen512.png)
...
![Output Tok/J Heatmap small models](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/7a_tok_j_heatmap_small_models.png)
...
![Output Tok/J Heatmap large models](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/7b_tok_j_heatmap_large_models.png)
...
![Bonsai-8B Output Tok/J Spotlight](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/12_bonsai_8b_tok_j_spotlight.png)
...
![Prefill tok/J vs prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22e_prefill_tokj_vs_prompt_gen512.png)
...
![Decode tok/J vs prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22f_decode_tokj_vs_prompt_gen512.png)
...
![Total tok/J vs prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22g_total_tokj_vs_prompt_gen512.png)
...
![Prefill phase power heatmap](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EP_prefill_power_heatmap_canonical.png)

<a id="figure-7e"></a>
**Figure 7e: Decode phase power (W) - all models × all power modes (ctx=2048, gen=512)**

![Decode phase power heatmap](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EP_decode_power_heatmap_canonical.png)
...
![TTFT vs Prompt](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/5_ttft_vs_prompt.png)
...
![ITL Comparison](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/8_itl_compare.png)
...
![Request Latency Comparison](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/10_request_latency_compare.png)
...
![Prefill Comparison](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/9_prefill_compare.png)
...
![Avg Power Bar](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/4_avg_power_bar.png)
...
|----------|-----------------|
| Always-on inference (sub-4B) | 25W: best [output tok/J](#appendix-h3) and tok/sec balance; vs 15W: +47-48% tok/s, +46-48% [`TTFT`](#glossary), +2-5% [output tok/J](#appendix-h3) |
| Interactive chat, real-time response (sub-4B) | MAXN: lowest prefill time ([`TTFT`](#glossary)) and highest tok/sec; vs 25W: +8-10% tok/s, +10% prefill time ([`TTFT`](#glossary)), -9-12% [output tok/J](#appendix-h3) |
| Power-constrained / thermally limited (sub-4B) | 15W: saves 28-32% power vs 25W; vs 25W: -32% tok/s, -32% [`TTFT`](#glossary), -2-5% [output tok/J](#appendix-h3) |
| Edge AI / Smartphone deployment | 7W: all 8 models fit (reboot per run required); vs 15W: -61-64% tok/s, -63-68% [`TTFT`](#glossary), -6-14% [output tok/J](#appendix-h3); lowest power budget |
...
![Speedup vs 15W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/6_speedup_vs_15w.png)
...
<table>
<tr>
<td align="center"><strong>7W</strong><br><img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_7w.png" width="100%"></td>
<td align="center"><strong>15W</strong><br><img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_15w.png" width="100%"></td>
</tr>
<tr>
<td align="center"><strong>25W</strong><br><img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_25w.png" width="100%"></td>
<td align="center"><strong>MAXN</strong><br><img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_maxn.png" width="100%"></td>
</tr>
</table>

**Figure 10a: [`ITL`](#glossary) p50 heatmaps - all 4 power modes (rows = gen length, cols = prompt length)**

- [`ITL`](#glossary) is driven primarily by model size and GPU clock (or power mode) but also loosely on prompt length too, like between ctx length=256 to ctx length=2048, the [`ITL`](#glossary) increases because of the larger context (prompt + generation -> kv cache scans increases too). **Bonsai** models have lower [`ITL`](#glossary) than *Ternary* models at every mode.
...
**Request latency (E2E) speedup** - median([`RL`](#glossary) p50 at baseline) / median([`RL`](#glossary) p50 at mode) over all 12 prompt × gen combos (see [H.9](#appendix-h9)):
...
![Best Output Tok/J per Model](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/3_best_tok_j_bar.png)
...
> [`prefill_J`](#appendix-h5) = [`prefill_power_W`](#appendix-h5) x [`TTFT`](#glossary)_p50_s; [`decode_J`](#appendix-h5) = [`decode_power_W`](#appendix-h5) x [`decode_time_p50_s`](#appendix-h5); `prefill%` = [`prefill_J`](#appendix-h5) / ([`prefill_J`](#appendix-h5) + [`decode_J`](#appendix-h5)). Phase power from tegrastats samples assigned to exact phase windows via per-request nanosecond timestamps. See [H.5](#appendix-h5).
...
> Ratios show how much more power mode A draws vs mode B (ratio > 1 = A draws more). Computed from [`VDD_CPU_GPU_CV`](#glossary) tegrastats samples assigned to prefill/decode phase windows via per-request nanosecond timestamps; median over all 12 prompt x gen combos. See [H.5](#appendix-h5) for phase assignment methodology.
...
![Total energy vs output length at 25W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_total_energy_vs_gen_length.png)

<a id="figure-16"></a>
**Figure 16: Decode energy per output token in mJ (ctx=2048, gen=512)**

![mJ per output token by mode](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_mj_per_output_token.png)
...
- **0.24 s [`TTFT`](#glossary)** at ctx=256 (25W)
...
Bonsai-1.7B Q1_0 pushes even further: **5.84 output tok/J** (ctx=256, gen=256) in only **237 MB** at **4.51 W** average under load, **26.0 tok/s** and **0.21 s [`TTFT`](#glossary)** (25W, ctx=256). Total tok/J peaks at **62.5** (ctx=2048, gen=128, best in suite) where the long prompt dominates the numerator. 
...
- *~47 % more* throughput than 15W (1.7B class) and *~46-47 % faster* [`TTFT`](#glossary) (prefill time)
...
![Tok/s heatmap 7W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_s_heatmap_7w.png)

**Figure C.1b: All 12 combos at 15W**

![Tok/s heatmap 15W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_s_heatmap_15w.png)

**Figure C.1c: All 12 combos at 25W**

![Tok/s heatmap 25W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_s_heatmap_25w.png)

**Figure C.1d: All 12 combos at MAXN**

![Tok/s heatmap MAXN](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_s_heatmap_maxn.png)
...
![Tok/J heatmap 7W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_j_heatmap_7w.png)

**Figure C.2b: All 12 combos at 15W**

![Tok/J heatmap 15W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_j_heatmap_15w.png)

**Figure C.2c: All 12 combos at 25W**

![Tok/J heatmap 25W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_j_heatmap_25w.png)

**Figure C.2d: All 12 combos at MAXN**

![Tok/J heatmap MAXN](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_tok_j_heatmap_maxn.png)

<a id="appendix-c3"></a>
### C.3 Phase power heatmaps (prefill and decode W)

Observed [`VDD_CPU_GPU_CV`](#glossary) power during the prefill and decode phases separately, across all 12 prompt × gen combinations per power mode. Prefill is compute-heavy (batched forward pass); decode is memory-bandwidth bound (one token at a time) - the difference in watts between the two phases is visible in every mode.

**Figure C.3a: Prefill power (W) at 7W**

![Prefill power heatmap 7W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_prefill_power_heatmap_7w.png)

**Figure C.3b: Prefill power (W) at 15W**

![Prefill power heatmap 15W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_prefill_power_heatmap_15w.png)

**Figure C.3c: Prefill power (W) at 25W**

![Prefill power heatmap 25W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_prefill_power_heatmap_25w.png)

**Figure C.3d: Prefill power (W) at MAXN**

![Prefill power heatmap MAXN](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_prefill_power_heatmap_maxn.png)

**Figure C.3e: Decode power (W) at 7W**

![Decode power heatmap 7W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_decode_power_heatmap_7w.png)

**Figure C.3f: Decode power (W) at 15W**

![Decode power heatmap 15W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_decode_power_heatmap_15w.png)

**Figure C.3g: Decode power (W) at 25W**

![Decode power heatmap 25W](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_decode_power_heatmap_25w.png)

**Figure C.3h: Decode power (W) at MAXN**

![Decode power heatmap MAXN](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/E_decode_power_heatmap_maxn.png)
...
![Prefill tok/J vs prompt gen=128](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_prefill_tokj_vs_prompt_gen128.png)

**Figure D.1b: Prefill tok/J vs prompt length: gen=256**

<a id="figure-d1b"></a>

![Prefill tok/J vs prompt gen=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22e_prefill_tokj_vs_prompt_gen256.png)
...
![Decode tok/J vs gen ctx=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_decode_tokj_vs_gen_ctx256.png)

**Figure D.2b: Decode tok/J vs gen length: ctx=512**

<a id="figure-d2b"></a>

![Decode tok/J vs gen ctx=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_decode_tokj_vs_gen_ctx512.png)

**Figure D.2c: Decode tok/J vs gen length: ctx=1024**

<a id="figure-d2c"></a>

![Decode tok/J vs gen ctx=1024](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_decode_tokj_vs_gen_ctx1024.png)

**Figure D.2d: Decode tok/J vs gen length: ctx=2048**

<a id="figure-d2d"></a>

![Decode tok/J vs gen ctx=2048](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_decode_tokj_vs_gen_ctx2048.png)
...
![Total tok/J vs prompt gen=128](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_total_tokj_vs_prompt_gen128.png)

**Figure D.3b: Total tok/J vs prompt length: gen=256**

<a id="figure-d3b"></a>

![Total tok/J vs prompt gen=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22g_total_tokj_vs_prompt_gen256.png)
...
![Request latency vs prompt gen=128](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EF_req_latency_vs_prompt_gen128.png)

**Figure E.1b: Request latency vs prompt length: gen=256**

<a id="figure-e1b"></a>

![Request latency vs prompt gen=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22a_request_latency_vs_prompt_gen256.png)

**Figure E.1c: Request latency vs prompt length: gen=512** *(canonical)*

![Request latency vs prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/22a_request_latency_vs_prompt_gen512.png)
...
![TTFT vs prompt gen=128](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_vs_prompt_gen128.png)

**Figure E.2b: [`TTFT`](#glossary) vs prompt length: gen=256**

![TTFT vs prompt gen=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_vs_prompt_gen256.png)

**Figure E.2c: [`TTFT`](#glossary) vs prompt length: gen=512** *(canonical)*

![TTFT vs prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_vs_prompt_gen512.png)
...
<td align="center">
  ...
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_heatmap_7w.png" width="100%">
</td>
<td align="center">
  <a id="figure-e3b"></a>
  <strong>Figure E.3b: <a href="#glossary"><code>TTFT</code></a> heatmap: 15W</strong><br>
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_heatmap_15w.png" width="100%">
</td>
</tr>
<tr>
<td align="center">
  ...
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_heatmap_25w.png" width="100%">
</td>
<td align="center">
  <a id="figure-e3d"></a>
  <strong>Figure E.3d: <a href="#glossary"><code>TTFT</code></a> heatmap: MAXN</strong><br>
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EG_ttft_heatmap_maxn.png" width="100%">
</td>
</tr>
</table>
...
![ITL vs prompt gen=128](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_vs_prompt_gen128.png)

**Figure F.1b: [`ITL`](#glossary) vs prompt length: gen=256**

<a id="figure-f1b"></a>

![ITL vs prompt gen=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_vs_prompt_gen256.png)

**Figure F.1c: [`ITL`](#glossary) vs prompt length: gen=512** *(canonical, also in section 2.3)*

<a id="figure-f1c"></a>

![ITL vs prompt gen=512](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_vs_prompt_gen512.png)
...
<td align="center">
  ...
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_7w.png" width="100%">
</td>
<td align="center">
  <a id="figure-f2b"></a>
  <strong>Figure F.2b: <a href="#glossary"><code>ITL</code></a> heatmap: 15W</strong><br>
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_15w.png" width="100%">
</td>
</tr>
<tr>
<td align="center">
  ...
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_25w.png" width="100%">
</td>
<td align="center">
  <a id="figure-f2d"></a>
  <strong>Figure F.2d: <a href="#glossary"><code>ITL</code></a> heatmap: MAXN</strong><br>
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EH_itl_heatmap_maxn.png" width="100%">
</td>
</tr>
</table>
...
![Prefill tput vs prompt gen=128](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EI_prefill_tput_vs_prompt_gen128.png)

**Figure G.1b: Prefill throughput vs prompt length: gen=256**

![Prefill tput vs prompt gen=256](/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EI_prefill_tput_vs_prompt_gen256.png)
...
<td align="center">
  ...
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EI_prefill_tput_heatmap_7w.png" width="100%">
</td>
<td align="center">
  <a id="figure-g2b"></a>
  <strong>Figure G.2b: Prefill throughput heatmap: 15W</strong><br>
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EI_prefill_tput_heatmap_15w.png" width="100%">
</td>
</tr>
<tr>
<td align="center">
  ...
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EI_prefill_tput_heatmap_25w.png" width="100%">
</td>
<td align="center">
  <a id="figure-g2d"></a>
  <strong>Figure G.2d: Prefill throughput heatmap: MAXN</strong><br>
  <img src="/images/blogs/jetson-orin-nano-super-benchmark-bonsai/charts/EI_prefill_tput_heatmap_maxn.png" width="100%">
</td>
</tr>
</table>
...
<a id="appendix-h11"></a>
### H.11 [`TTFT`](#glossary), [`ITL`](#glossary), [`RL`](#glossary) percentiles
